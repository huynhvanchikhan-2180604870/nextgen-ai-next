...
export default function AIPlanner() {
  ...
  const handleSendMessage = async () => {
    ...
    if (sessionId) {
      ...
      try {
        const response = await fetch(
          `${API_CONFIG.BASE_URL}/api/v1/ai-chat/sessions`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
      ...
      <div className="flex h-screen">
        ...
        <div className="hidden md:flex w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex-col">
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="mt-3">
              <input
                ...
                className="w-full px-3 py-2 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-2">
              {/* Current Chat */}
              <div className="flex items-center p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer bg-blue-50 dark:bg-blue-900/20">
